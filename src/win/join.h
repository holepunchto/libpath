#ifndef PATH_WIN_JOIN_H
#define PATH_WIN_JOIN_H
...
static inline int
path_join_windows (const char *fragments[], char *buf, size_t *len) {
  ...
  *len = offset;
  ...
  int e = path_normalize_windows(buf, buf, len);
